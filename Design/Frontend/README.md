...
## 🧱 4 TẦNG (đọc từ trên xuống — trên định hướng dưới)
...
| — | **Other** | `Other/` | *Cross-cutting: Motion · Accessibility · Voice & Content · Icons.* |
...
* `0.ArtDirection.md` — ✅ **đã viết đầy** cho ReportSupporter.
* `1.Foundations/` — token canonical đã có; `Typography.md` = skeleton.
* `2.Components/` — ✅ **đã điền đầy 8 spec:** Button · Input · Select · Textarea · Badge · Dialog · Tabs · Toast (khuôn `_ComponentSpecRule.md`).
* `Other/VoiceAndContent.md` · `Other/Icons.md` — ✅ đã điền (copy library + Lucide).
* `3.Patterns/`, `4.Layouts/`, `5.Flows/`, `Other/Motion.md`, `Other/Accessibility.md` — skeleton, điền dần theo tuần.
