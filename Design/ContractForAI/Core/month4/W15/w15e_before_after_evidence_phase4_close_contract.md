...
**Before/after evidence** (light/dark × ≥3 viewport) các màn chính + QA report (DoD + Art Direction §11 + axe summary + coverage) + cập nhật trạng thái Frontend (Flows/Layouts/Patterns → implemented, "axe automated"). Chạy 4 gates + axe (0 critical). **Đóng Phase 4.**
...
### In scope (`[C164]`/`[C165]`)
- `Design/Reports/Month4/W15/screenshots/` (**NEW**): before/after (light/dark × ≥3 viewport) các màn chính (Write/Check/Export/Present/Shell).
- `Design/Reports/Month4/W15/W15_QA_Report.md` (**NEW**): map DoD + `0.ArtDirection.md §11` + axe summary (0 critical) + Pattern/Layout/Flow coverage.
...
## 3. Checklist
- [ ] Before/after screenshots (light/dark × ≥3 viewport) các màn chính.
- [ ] lint/typecheck/test/build xanh; axe 0 critical (light+dark).
- [ ] QA report map DoD + §11 + axe summary + coverage.
...
| `Design/Reports/Month4/W15/W15_QA_Report.md` | NEW | DoD + §11 + axe summary |
