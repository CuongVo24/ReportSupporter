...
export type { SlideOutline, PresentationTimeline, Speaker, SpeakerScript } from "./present";
...
export { slideOutlineSchema, presentationTimelineSchema, speakerSchema, speakerScriptSchema } from "./present";
