...
export type { SlideOutline, PresentationTimeline, Speaker, SpeakerScript, DefenseQA } from "./present";
...
export { slideOutlineSchema, presentationTimelineSchema, speakerSchema, speakerScriptSchema, defenseQASchema } from "./present";
